...
// --- MODAL DE LECTURA PRO (CON CARRUSEL DE IMÁGENES) ---
window.openModal = function(article) {
    ...
    if (track) {
        ...
        if (article.image2) images.push(article.image2);
        if (article.image3) images.push(article.image3);
        ...
        if (oldImg) oldImg.src = article.image;
    }
